...
var server = http.createServer(function (req, res) {
    ...
    try {
        var reg = /\.(TXT|HTML|CSS|JS|PNG|JPG|GIF|JPEG|SVG|ICON|ICO|MP3|OGG|WAV|MP4|WEBM|WEBP|BMP|WOFF|WOFF2|TTF)/i;
        if (reg.test(pathname)) {
            ...
            switch (suffix) {
                ...
                case "WEBM":
                    ...
                    break;
                case "WEBP":
                    suffixType = "image/webp";
                    break;
                case "WOFF":
                case "WOFF2":
                    suffixType = "application/x-font-woff";
                    break;
                case "TTF":
                    suffixType = "application/octet-stream";
                    break;
            }
